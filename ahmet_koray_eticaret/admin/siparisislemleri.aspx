<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="siparisislemleri.aspx.cs" Inherits="ahmet_koray_eticaret.admin.siparisislemleri" %>
...
<body>
    <form id="form1" runat="server">
                    ...
                    >
                      ...
                      <tbody>
                        <tr class="odd">
                          ...
                          <td>
                            <select tabindex="1" class="span2">
                              <option value="">Sipariş Durumu</option>
                              <option value="Category 1">Admin</option>
                              <option value="Category 2">Normal Üye</option>
                            </select>
                          </td>
      ...
      <div class="footer">
        <div class="container">
          <b class="copyright">&copy; 2020 ÇELİK MARKET </b>Tüm hakları
          saklıdır.
        </div>
      </div>
